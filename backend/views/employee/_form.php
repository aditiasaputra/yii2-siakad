...
<?php $form = ActiveForm::begin([
    ...
    <div class="card card-info card-outline mb-3">
        ...
        <div class="card-body">
            <div class="row">
                <!-- Kolom Kiri: Informasi Kepegawaian & Bank (col-lg-12 untuk responsif) -->
                <div class="col-lg-12 col-md-12">
                ...
                <!-- Kolom Kanan: Nomor Jaminan Sosial & Catatan (col-lg-12 untuk responsif) -->
                <div class="col-lg-12 col-md-12">
                    ...
                    <h5 class="mt-4 mb-3 text-primary">Catatan Tambahan</h5>
                    <hr>
                    <?= $form->field($employeeModel, 'note')->textarea(['rows' => 4])->hint('Tambahkan catatan penting mengenai karyawan ini.') ?>
                </div>
            </div>
        </div>
        <div class="card-footer d-flex">
            ...
            <div class="ml-auto" id="action-right">
                <?= Html::a('<i class="fas fa-fw fa-arrow-left"></i><span> Batal</span>', $employeeModel->isNewRecord ? Url::to(['index']) : Url::to(['show', 'id' => $employeeModel->id]), ['class' => 'btn btn-sm btn-secondary mr-1']) ?>
