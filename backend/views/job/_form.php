...
<div class="card card-primary card-outline mb-3">
    <div class="card-header"><h3 class="card-title mb-0"><?= $model->isNewRecord ? 'Form Tambah Pekerjaan' : 'Form Ubah Pekerjaan' ?></h3></div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Contoh: PNS']) ?>
            </div>
        </div>
    </div>
