        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'Jenis Mata Kuliah', 'icon' => 'fas fa-book-open', 'url' => ['subject-type/index'], 'active' => Yii::$app->controller->id === 'subject-type'],
                    ['label' => 'Kelompok Mata Kuliah', 'icon' => 'fas fa-layer-group', 'url' => ['subject-group/index'], 'active' => Yii::$app->controller->id === 'subject-group'],
                    ['label' => 'Bidang Ilmu', 'icon' => 'fas fa-atom', 'url' => ['field-of-study/index'], 'active' => Yii::$app->controller->id === 'field-of-study'],
                    ['label' => 'Kelas Perkuliahan', 'icon' => 'fas fa-chalkboard', 'url' => ['course-class/index'], 'active' => Yii::$app->controller->id === 'course-class'],
                    ['label' => 'Slot Waktu', 'icon' => 'fas fa-clock', 'url' => ['time-slot/index'], 'active' => Yii::$app->controller->id === 'time-slot'],
                    ['label' => 'Status Hadir', 'icon' => 'fas fa-user-check', 'url' => ['attendance-status/index'], 'active' => Yii::$app->controller->id === 'attendance-status'],
                    ['label' => 'Tahun Kurikulum', 'icon' => 'fas fa-calendar-alt', 'url' => ['curriculum-year/index'], 'active' => Yii::$app->controller->id === 'curriculum-year'],
                    ...
                    ['label' => 'Kelas Kuliah', 'icon' => 'fas fa-chalkboard-teacher', 'url' => ['lecture-class/index'], 'active' => Yii::$app->controller->id === 'lecture-class'],
                    ['label' => 'Laporan Jadwal Mingguan', 'icon' => 'fas fa-calendar-week', 'url' => ['weekly-schedule-report/index'], 'active' => Yii::$app->controller->id === 'weekly-schedule-report'],
                    ['label' => 'KRS', 'header' => true],
                    ['label' => 'Cekal KRS', 'icon' => 'fas fa-user-lock', 'url' => ['krs-block/index'], 'active' => Yii::$app->controller->id === 'krs-block'],
                    ['label' => 'Pengaturan Prodi', 'icon' => 'fas fa-cogs', 'url' => ['study-program-setting/index'], 'active' => Yii::$app->controller->id === 'study-program-setting'],
                    ['label' => 'Status Semester', 'icon' => 'fas fa-calendar-check', 'url' => ['student-semester-status/index'], 'active' => Yii::$app->controller->id === 'student-semester-status'],
                    ['label' => 'Proses KRS', 'icon' => 'fas fa-tasks', 'url' => ['krs-registration/index'], 'active' => Yii::$app->controller->id === 'krs-registration'],
                    ['label' => 'Pembimbing Akademik', 'icon' => 'fas fa-user-tie', 'url' => '#'],
                    ['label' => 'Paket Kuliah', 'icon' => 'fas fa-box-open', 'url' => '#'],
                    ['label' => 'Laporan KRS', 'icon' => 'fas fa-file-alt', 'url' => '#'],
