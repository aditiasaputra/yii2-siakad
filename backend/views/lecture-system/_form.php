...
/** @var backend\models\LectureSystem $model */
?>

<?= Alert::widget() ?>
<div class="card card-primary card-outline mb-3">
    <div class="card-header"><h3 class="card-title mb-0"><?= $model->isNewRecord ? 'Form Tambah Sistem Kuliah' : 'Form Ubah Sistem Kuliah' ?></h3></div>
    <?php $form = ActiveForm::begin([
        'id' => 'lecture-system-form',
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <?= $form->field($model, 'code')->textInput(['maxlength' => true, 'autofocus' => true, 'inputmode' => 'numeric', 'placeholder' => 'Contoh: 1']) ?>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Contoh: Reguler']) ?>
            </div>
        </div>
    </div>
