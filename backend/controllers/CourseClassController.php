...
use backend\models\CourseClassSearch;
use Yii;
...
class CourseClassController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Kelas Perkuliahan berhasil ditambahkan.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Kelas Perkuliahan berhasil diperbarui.');
            return $this->redirect(['view', 'id' => $model->id]);
        }
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException('Kelas Perkuliahan tidak ditemukan.');
    }
}
